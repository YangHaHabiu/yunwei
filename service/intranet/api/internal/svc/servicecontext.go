...
func NewServiceContext(c config.Config) *ServiceContext {
	...
	return &ServiceContext{
		...
		IntranetRpc: intranet.NewIntranet(zrpc.MustNewClient(c.IntranetRpcConf, zrpc.WithUnaryClientInterceptor(metaserver.NameToInterceptor), zrpc.WithDialOption(dialOption))),
	}
}
