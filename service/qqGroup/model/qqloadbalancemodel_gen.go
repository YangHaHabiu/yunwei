...
type (
	qqLoadBalanceModel interface {
		...
		FindAll(ctx context.Context) (*[]QqLoadBalance, error)
...
func (m *defaultQqLoadBalanceModel) FindAll(ctx context.Context) (*[]QqLoadBalance, error) {

	query := fmt.Sprintf("select %s from %s ", qqLoadBalanceRows, m.table)
	var resp []QqLoadBalance
